...
public class NeoRestResponseDetails<T> {
	...
	public NeoRestResponseDetails() {
	}

	@JsonIgnore
	public NeoRestResponseDetails(T responseEntity, Integer statusCode, String statusMessage, String targetResourceRefId,

...
export class PartnerEDIListComponent implements OnInit {
  ...
  constructor(private cpService: CompanyProfileService,
    ...
    private tradingParnterDetails: TradingParnterDetailsService, public datepipe: DatePipe, private matomoTracker: MatomoTracker) {
  }
  ngOnInit() {
    this.matomoTracker.trackPageView("Community Manager: My Trading Community - EDI & Comms");

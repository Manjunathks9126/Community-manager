...
export class ManagementComponent implements OnInit {
  ...
  selectGroup(data, position) {
    ...
    if (data == null) return;
    this.selectedFieldGroup = new CustomFieldGroupType(data.uniqueId, data.name, data.description, data.ownerBusinessUnit.buId, '', [], '');
    let temp: any;
  ...
  addGroup() {
    this.newFieldGroup = new CustomFieldGroupType(null, null, null, null, null, [], null);
